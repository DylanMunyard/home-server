...
3. Replace /boot/dietpi.txt with the following, then make the following edits:
...
# Hostname
AUTO_SETUP_NET_HOSTNAME=pi-town-1
...
AUTO_SETUP_GLOBAL_PASSWORD=SUPER_SECRET_PASSWORD_HERE
...
SOFTWARE_K3S_EXEC=agent -s https://192.168.1.215:6443 -t PUT_THE_K3S_SERVER_TOKEN_HERE
